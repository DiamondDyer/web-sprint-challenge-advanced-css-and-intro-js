...
Acessibility helps make everything easier to use and helps assist people who need it. 
2. Talk about 3 different things you can do to ensure your website is accessible. 
You can use alt tags on images, make sure your html is semantic, and use the acessibility checker in the inspect in your browser. 
3. How would you explain the concept of a variable to someone new to programming?
A variable holds information for later. 
4. What is the purpose of using functions in code?
Funtions allow you to easily reuse code. 
